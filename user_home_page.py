...
def user_home_page():
    ...
    if select == 'Patient Profile':
        ...
        /* Apply background image to the main content area */
        .main {
            background-image: url("https://img.freepik.com/free-vector/polygon-lines-background_1035-7063.jpg");
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            background-color: rgba(255, 255, 255, 0.6);
        ...
        try:
            ...
            with col1:
                ...
                st.download_button(label="📥 Download Report", data=report_data, file_name="Patient_Report.html", mime="text/html",type='primary')
                st.markdown('</div>', unsafe_allow_html=True)
