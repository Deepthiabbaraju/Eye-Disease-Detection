...
import random
from database import valid_user, add_otp, fetch_otp, update_password, fetch_password
import smtplib
...
def forgot_password_page():
    st.markdown(
        ...
        .main {
            background-image: url('https://cache.desktopnexus.com/thumbseg/1370/1370503-bigthumbnail.jpg');
